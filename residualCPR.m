function dF = residualCPR(q,K,L,dg)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
dF1 = df1 + dg.RR*(nflux1L - f1_lbd) + dg.RL*(nflux1R - f1_rbd);
dF2 = df2 + dg.RR*(nflux2L - f2_lbd) + dg.RL*(nflux2R - f2_rbd);
dF3 = df3 + dg.RR*(nflux3L - f3_lbd) + dg.RL*(nflux3R - f3_rbd);
dF = -[dF1;dF2;dF3];